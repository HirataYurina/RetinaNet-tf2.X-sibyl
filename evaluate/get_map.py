...
# Evaluate my model
# ----------------------------------------------------
MINOVERLAP = config.DETECT.mAP_THRES  # default value (defined in the PASCAL VOC2012 challenge)
...
GT_PATH = os.path.join(os.getcwd(), 'mAP', 'ground-truth')
DR_PATH = os.path.join(os.getcwd(), 'mAP', 'detection-results')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'mAP', 'images-optional')
...
results_files_path = "mAP_result/results"
